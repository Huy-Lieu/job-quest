...
import { RunSearchPanel } from '@/app/components/PhD/PhDConfigForms'
import { PhDJobsTab } from '@/app/components/PhD/PhDJobsTab'
import { PhDConfigsTab } from '@/app/components/PhD/PhDConfigsTab'
...
export default function PhDPage() {
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      {/* Runs Tab */}
      {tab === 'runs' && (
        <RunsTab runs={runs} loadingRuns={loadingRuns} fetchRuns={fetchRuns} />
      )}
